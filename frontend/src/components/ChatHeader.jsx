...
const ChatHeader = ({ sender, setMessages, messages }) => {
  ...
  return (
    <div className="fixed md:static w-full flex items-center justify-between gap-9 bg-white dark:text-white dark:bg-dark-grayish  py-2 px-3 lg:px-10 shadow-2xl">
