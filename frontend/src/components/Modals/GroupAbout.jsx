...
const GroupAbout = () => {
  ...
  return (
    <div className="bg-white dark:bg-dark-secondary dark:text-white shadow-xl w-96 max-w-[90vw] h-min-72 fixed top-1/2 left-1/2 translate-y-[-50%] translate-x-[-50%] p-4 ">
      ...
      <pre className="mt-1 whitespace-pre-wrap">{selectedChat.groupDesc}</pre>
      <div className="text-lg font-semibold mt-6">Users</div>
      <div className="flex flex-col h-56 max-h-[50%] overflow-auto gap-3 mt-2">
